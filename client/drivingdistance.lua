        ...
        while true do
            ...
            if isDriver then
                ...
                if drivingDistance[plate] then
                    TriggerServerEvent('kg-mechanicjob:server:updateDrivingDistance', plate, drivingDistance[plate].distance)
                    TriggerServerEvent('kg-mechanicjob:server:updateVehicleComponents', plate, vehicleComponents[plate])
                end
                plate = nil
                vehicle = nil
                break
